...
class TestLes1Step11():
    ...
    def test_function1(self):
        ...
        assert var_text_temp.text == "Congratulations! You have successfully registered!", "Фраза некорректна"
    ...
    def test_function2(self):
        ...
        var_text_temp = driver.find_element(By.TAG_NAME, "h1")
        assert var_text_temp.text == "ongratulations! You have successfully registered!", "Фраза некорректна"
